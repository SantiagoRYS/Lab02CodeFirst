    ...
    public static class AutorLibroDataInitializer
    {
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            if (!context.Autores.Any() && !context.Libros.Any() && !context.AutorLibros.Any())
            {
                ...
                {
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-84-376-0494-7", Titulo = "Cien años de soledad", NumeroPaginas = 471, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-84-376-0495-4", Titulo = "La hojarasca", NumeroPaginas = 182, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-8943-77-0", Titulo = "El amor en los tiempos del cólera", NumeroPaginas = 348, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-0891-8", Titulo = "Delirio", NumeroPaginas = 307, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-06-0093-4", Titulo = "La casa grande", NumeroPaginas = 159, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-8969-31-3", Titulo = "Satanás", NumeroPaginas = 224, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-06-0093-5", Titulo = "La rebelión de las ratas", NumeroPaginas = 193, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-42-5701-3", Titulo = "María", NumeroPaginas = 286, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-42-2874-6", Titulo = "Los ejércitos", NumeroPaginas = 150, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-545-622-1", Titulo = "El ruido de las cosas al caer", NumeroPaginas = 254, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-544-646-8", Titulo = "Rosario Tijeras", NumeroPaginas = 182, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-894-826-6", Titulo = "El olvido que seremos", NumeroPaginas = 366, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-891-625-8", Titulo = "La carroza de Bolívar", NumeroPaginas = 365, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-598-426-7", Titulo = "La novia oscura", NumeroPaginas = 422, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-8160-25-5", Titulo = "El desbarrancadero", NumeroPaginas = 199, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-3301-4", Titulo = "Paraíso Travel", NumeroPaginas = 315, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-4552-0", Titulo = "Que viva la música", NumeroPaginas = 223, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-8951-60-5", Titulo = "Cóndores no entierran todos los días", NumeroPaginas = 285, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-3835-5", Titulo = "Sin remedio", NumeroPaginas = 402, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-5503-1", Titulo = "El oro y la oscuridad", NumeroPaginas = 284, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-2874-5", Titulo = "La tejedora de coronas", NumeroPaginas = 364, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-5456-22-2", Titulo = "Los elegidos", NumeroPaginas = 269, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-4646-5", Titulo = "El general en su laberinto", NumeroPaginas = 285, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-45-1234-6", Titulo = "Los días azules", NumeroPaginas = 297, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-42-1234-5", Titulo = "Memorias de mis putas tristes", NumeroPaginas = 112, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-544-923-0", Titulo = "El coronel no tiene quien le escriba", NumeroPaginas = 90, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-42-4545-0", Titulo = "El otoño del patriarca", NumeroPaginas = 270, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-43-9898-0", Titulo = "Los funerales de la Mamá Grande", NumeroPaginas = 130, Formato = "Digital" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-07-2978-6", Titulo = "La mala hora", NumeroPaginas = 233, Formato = "Fisico" },
                    new Libro { LibroId = Guid.NewGuid(), ISBN = "978-958-06-0087-1", Titulo = "Crónica de una muerte anunciada", NumeroPaginas = 124, Formato = "Digital" }
                };
